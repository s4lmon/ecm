...
# 7 "/Applications/microchip/xc8/v2.00/pic/include/c90/stdarg.h"
...
# 43 "/Applications/microchip/xc8/v2.00/pic/include/c90/stdio.h"
struct __prbuf
{
char * ptr;
void (* func)(char);
...
# 29 "/Applications/microchip/xc8/v2.00/pic/include/c90/errno.h"
extern int errno;

# 12 "/Applications/microchip/xc8/v2.00/pic/include/c90/conio.h"
...
# 88 "/Applications/microchip/xc8/v2.00/pic/include/c90/stdio.h"
...
# 7 "/Applications/microchip/xc8/v2.00/pic/include/c90/stdlib.h"
...
# 104 "/Applications/microchip/xc8/v2.00/pic/include/c90/stdlib.h"
...
# 52 "/Applications/microchip/xc8/v2.00/pic/include/pic18f4331.h"
...
# 18 "/Applications/microchip/xc8/v2.00/pic/include/pic18.h"
...
void store(char counter, char dir, char time) {
forwardsDir[counter] = dir;
forwardsTime[counter] = time;
}
...
stop(&mL, &mR);
if (forwardsDir[counter] == 3) {
backwards(&mL, &mR);
delay_tenth_s(forwardsTime[counter]);
} else if (forwardsTime[counter] == 1) {
T0CONbits.TMR0ON = 0;
TMR0L = 0;
TMR0H = 0;
millis = 0;
if (forwardsTime[counter] == 1) {
T0CONbits.TMR0ON = 1;
turnRight(&mL, &mR);
while (millis < forwardsTime[counter]);
