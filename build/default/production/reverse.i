...
void PWM_Init(int PWMperiod);
void Motor_Init(void);
void setMotorPWM(struct DC_motor *m);
void MStop(struct DC_motor *mL, struct DC_motor *mR);
void MLeft(struct DC_motor *mL, struct DC_motor *mR, char Speed);
void MRight(struct DC_motor *mL, struct DC_motor *mR, char Speed);
void MForward(struct DC_motor *mL, struct DC_motor *mR, char Speed);
void MReverse(struct DC_motor *mL, struct DC_motor *mR, char Speed);
void delay_s(char seconds, char tenths);
void delay_ms(unsigned int ms);
void MSmooth(struct DC_motor *mL, struct DC_motor *mR, signed char OldSpeedL, signed char OldSpeedR, signed char NewSpeedL, signed char NewSpeedR);
...
*forwardsDirection = direction;
*forwardsTime = ((TMR0H << 8) | TMR0L);
count++;
TMR0H = 0;
TMR0L = 0;
